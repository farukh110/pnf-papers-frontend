import RefundPolicyImg from '../../assets/images/products/products-lisiting2.webp';
import './index.scss';
    ...
    return (
        <>
            <BreadcrumbBanner
                ...
                metaLink="/refund-policy"
                imageSource={RefundPolicyImg}
                imageAlt="Refund Policy"
                bannerHeading="Refund Policy"
                homeTitle="Home"
                homeLink="/"
                pageLink="/refund-policy"
            />

            <section className="refund-main-content my-5">
