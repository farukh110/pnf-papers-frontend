import TermsImg from '../../assets/images/products/products-lisiting2.webp';
import './index.scss';
    ...
    return (
        <>
            <BreadcrumbBanner
                ...
                metaLink="/terms-&-conditions"
                imageSource={TermsImg}
            ...
            <section className="terms-main-content my-5">
